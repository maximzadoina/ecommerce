...
exports.fetchCollectionStart = exports.fetchCollectionsAsync = void 0;
...
function fetchCollectionStart() {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, effects_1.takeEvery(shop_types_1.ShopActionTypes.FETCH_COLLECTIONS_START, fetchCollectionsAsync)];
            case 1:
                _a.sent();
                return [2 /*return*/];
        }
